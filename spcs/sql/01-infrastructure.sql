...
-- Grant access to the data database
GRANT USAGE ON DATABASE FEDERAL_FINANCIAL_DATA TO ROLE PRISM_APP_ROLE;
GRANT USAGE ON ALL SCHEMAS IN DATABASE FEDERAL_FINANCIAL_DATA TO ROLE PRISM_APP_ROLE;
GRANT SELECT ON ALL TABLES IN DATABASE FEDERAL_FINANCIAL_DATA TO ROLE PRISM_APP_ROLE;
GRANT SELECT ON ALL VIEWS IN DATABASE FEDERAL_FINANCIAL_DATA TO ROLE PRISM_APP_ROLE;

-- Grant future access
GRANT SELECT ON FUTURE TABLES IN DATABASE FEDERAL_FINANCIAL_DATA TO ROLE PRISM_APP_ROLE;
GRANT SELECT ON FUTURE VIEWS IN DATABASE FEDERAL_FINANCIAL_DATA TO ROLE PRISM_APP_ROLE;
