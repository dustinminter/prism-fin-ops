...
-- =============================================================================
CREATE OR REPLACE AGENT EOTSS_STAGING.PRISM_ANOMALY_INVESTIGATOR
    COMMENT = 'PRISM Anomaly Investigator: investigates Commonwealth spending anomalies, budget risks, and procurement patterns using FinOps intelligence'
    FROM SPECIFICATION $$
orchestration:
  budget:
    seconds: 60
...
instructions:
  ...
  response: "Respond in a professional but accessible manner, suitable for budget officers and agency leadership."

tools:
  - tool_spec:
      type: "cortex_analyst_text_to_sql"
      name: "FinOpsAnalyst"
      description: "Queries Commonwealth financial data including spending, budgets, procurement, and workforce costs"

tool_resources:
  FinOpsAnalyst:
    semantic_view: "FEDERAL_FINANCIAL_DATA.EOTSS_STAGING.PRISM_EOTSS_FINOPS"
$$;
